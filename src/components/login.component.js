    ...
    render() {
        ...
        <div class="form-group" data-toggle="buttons" onChange={this.setChoice.bind(this)}>
            <label class="btn btn-secondary rounded">
                <input type="radio" name="options" id="option1" autocomplete="off" value="/user"/> I am a User
            </label>
            <label class="btn btn-secondary rounded mx-1">
                <input type="radio" name="options" id="option2" autocomplete="off" value="/officer"/> I am a Officer
            </label>           
        </div>
        <div className="form-group">
